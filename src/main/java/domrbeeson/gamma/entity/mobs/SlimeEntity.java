...
public class SlimeEntity extends LivingEntity<SlimeMetadata> {
    ...
    public SlimeEntity(World world, Pos pos, SlimeMetadata meta) {
        super(EntityType.SLIME, world, pos, meta, new CollisionBox(pos, SLIME_BASE_SIZE * meta.getSize(), SLIME_BASE_SIZE * meta.getSize()), (short) 1); // Slime health is 1:1 health:size
    }
